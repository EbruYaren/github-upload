...
public class SampleProducer extends Thread {
    ...
    public SampleProducer(KafkaProducer<Integer, String> producer, String topic, Boolean isAsync, String currencyCode, LocalDate startDate, LocalDate endDate) {
    ...
    public SampleProducer(String topic, Boolean isAsync, String currencyCode, LocalDate startDate, LocalDate endDate) {
    ...
    public void run() {
        ...
        String messageStr = "Message_" + messageNo;
            ...
            if (isAsync) { // Send asynchronously
                ...
                try {
                    producer.send(new ProducerRecord(topic, map)).get();
                    log.debug("Map is sent to the producer {}", map);
//                    producer.send(new ProducerRecord(topic,
//                        messageNo,
//                        messageStr)).get();
